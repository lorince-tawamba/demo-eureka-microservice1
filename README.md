...
- demo-microservice2-1.0.0

**Create the docker image**

```bash
  docker build -t lorincetawamba/demo-microservice2:1.0.0 -f Dockerfile .
```
...
```bash
  docker run -d -p 8082:8082 -t lorincetawamba/demo-microservice2:1.0.0
```
...
```bash
  docker image push lorincetawamba/demo-microservice2:1.0.0
```
